...
class Game(db.Model):
    ...
    player2 = db.Column(db.String(255), db.ForeignKey('players.email', ondelete="CASCADE"), nullable=False)
...
def add_game(player1_email, player2_email):
...
def add_cricket_card(player_name, power, strike_rate, wickets=0,
                     matches_played=0, runs_scored=0, highest_score=0, img=None):
    card = Cricket(
